  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <div id="footer">
          <p>Generated by the
            <a href="https://github.com/wintercms/wn-sitemap-plugin">Winter Sitemap</a>
            and
            <a href="https://github.com/josephcrowell/wn-sitemap-pretty-plugin">Joseph Crowell Sitemap Pretty</a>
            plugins.</p>
        </div>
      </body>
    </html>
